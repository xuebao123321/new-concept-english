...
export const RANKS: Rank[] = [
  { level: 1, name: '初级学者', minXp: 0, color: 'text-gray-500' },
  { level: 2, name: '初级学者 II', minXp: 50, color: 'text-gray-500' },
  { level: 3, name: '初级学者 III', minXp: 120, color: 'text-gray-500' },
  { level: 4, name: '上进学员', minXp: 200, color: 'text-gray-600' },
  { level: 5, name: '上进学员 II', minXp: 300, color: 'text-gray-600' },
  { level: 6, name: '上进学员 III', minXp: 500, color: 'text-gray-600' },
  { level: 7, name: '勤奋学员', minXp: 750, color: 'text-green-600' },
  { level: 8, name: '勤奋学员 II', minXp: 1000, color: 'text-green-600' },
  { level: 9, name: '勤奋学员 III', minXp: 1300, color: 'text-green-600' },
  { level: 10, name: '学习能手', minXp: 1600, color: 'text-green-600' },
  { level: 11, name: '学习能手 II', minXp: 2000, color: 'text-green-600' },
  { level: 12, name: '英语达人', minXp: 2500, color: 'text-blue-600' },
  { level: 13, name: '英语达人 II', minXp: 3000, color: 'text-blue-600' },
  { level: 14, name: '英语达人 III', minXp: 3500, color: 'text-blue-600' },
  { level: 15, name: '学霸精英', minXp: 4000, color: 'text-blue-600' },
  { level: 16, name: '学霸精英 II', minXp: 5000, color: 'text-purple-600' },
  { level: 17, name: '学霸精英 III', minXp: 6000, color: 'text-purple-600' },
  { level: 18, name: '新概念大师', minXp: 7500, color: 'text-orange-500' },
  { level: 19, name: '新概念大师 II', minXp: 9000, color: 'text-orange-500' },
  { level: 20, name: '英语传奇', minXp: 11000, color: 'text-red-500' },
];
