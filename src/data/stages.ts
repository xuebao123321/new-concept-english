...
export const STAGES: StageInfo[] = [
  ...
  },
  {
    ...
    lessonStart: 121,
    lessonEnd: 144,
    groups: ['lesson-121-122', 'lesson-123-124', 'lesson-125-126', 'lesson-127-128',
             'lesson-129-130', 'lesson-131-132', 'lesson-133-134', 'lesson-135-136',
             'lesson-137-138', 'lesson-139-140', 'lesson-141-142', 'lesson-143-144'],
