...
export const speakingQuestions: SpeakingQuestion[] = [
  ...
  },
  {
    ...
    chineseHint: '这是你的手提包吗?',
    keywords: ['is', 'this', 'your', 'handbag'],
    explanation: '一般疑问句 Is this ... 用于确认物品归属',
  },
  {
    id: 'speak-L03-001',
    type: 'speak',
    ...
    chineseHint: '对不起,先生',
    keywords: ['sorry', 'sir'],
    explanation: "Sorry 用于道歉,sir 是对男性的尊称",
  },
  {
    id: 'speak-L03-002',
    type: 'speak',
    ...
    block: 'sentence',
    prompt: '请朗读以下句子',
    sentence: 'This is not my umbrella.',
    chineseHint: '这不是我的雨伞',
    keywords: ['this', 'is', 'not', 'umbrella'],
    explanation: '否定句 This is not ... 表示这不是某物',
  },
];
